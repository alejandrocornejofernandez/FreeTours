...
if (props.sesion.rol !== "guia") router.push("/");
...
<template>
  <div class="view-routes-page py-5">
    <div class="container">
      ...
      <div class="row g-4 justify-content-center">
        ...
        <div v-if="vistaActiva == 'pendientes'" class="row g-4 justify-content-center">
          <div v-for="ruta in reservasPendientes" :key="ruta.id"
            ...
            <RouteCard :id="ruta.ruta_id" :titulo="ruta.ruta_titulo" :localidad="ruta.ruta_localidad"
              :descripcion="ruta.ruta_descripcion" :foto="ruta.ruta_foto" :reservasCliente="false"
        ...
        <div v-if="vistaActiva == 'yaHechas'" class="row g-4 justify-content-center">
          <div v-for="ruta in rutasHechas" :key="ruta.id"
            class="col-12 col-md-6 col-lg-4 d-flex justify-content-center">
            <RouteCard :id="ruta.ruta_id" :titulo="ruta.ruta_titulo" :localidad="ruta.ruta_localidad"
              :descripcion="ruta.ruta_descripcion" :foto="ruta.ruta_foto" :rutaYaHecha="true"
      ...
      <div
        v-if="(vistaActiva === 'pendientes' && reservasPendientes.length === 0) || (vistaActiva === 'yaHechas' && rutasHechas.length === 0)"
