...
<template>
  <div class="view-routes-page py-5">
    <div class="container">
      ...
      <div v-if="vistaActiva == 'pendientes'">
        <div class="row g-4 justify-content-center">
          <div v-for="ruta in reservasPendientes" :key="ruta.id" class="col-12 col-md-6 col-lg-4 d-flex flex-column align-items-center">
            <RouteCard 
              :reservasCliente="true" :id_reserva="ruta.reserva_id"
              :id="ruta.ruta_id" :titulo="ruta.ruta_titulo" :localidad="ruta.ruta_localidad"
              :descripcion="ruta.ruta_descripcion" :foto="ruta.ruta_foto" @rutaEliminada="recargarRutas"
            />
          </div>
        </div>
      </div>
      ...
      <div v-if="vistaActiva == 'yaHechas'">
        <div class="row g-4 justify-content-center">
          <div v-for="ruta in rutasHechas" :key="ruta.id" class="col-12 col-md-6 col-lg-4 d-flex flex-column align-items-center">
            <RouteCard 
              :reservasCliente="true" :id_reserva="ruta.reserva_id" :rutaYaHecha="true"
              :id="ruta.ruta_id" :titulo="ruta.ruta_titulo" :localidad="ruta.ruta_localidad"
              :descripcion="ruta.ruta_descripcion" :foto="ruta.ruta_foto" 
      ...
      <div v-if="(rutasHechas.length === 0 && vistaActiva == 'yaHechas') || (reservasPendientes.length === 0 && vistaActiva == 'pendientes')" class="text-center py-5">
